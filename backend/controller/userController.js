...
//   // console.log("Comparison result:", role.trim().toLowerCase() === user.role.trim().toLowerCase());

//   const userRole = (user.role || "").toString().trim().toLowerCase();
//   const inputRole = (role || "").toString().trim().toLowerCase();
...
export const login = catchAsyncErrors(async (req, res, next) => {
  ...
  // ✅ Final role comparison logic
  const userRole = (user.role || "").toString().trim().toLowerCase();
  const inputRole = (role || "").toString().trim().toLowerCase();

  console.log("Request role:", inputRole);
  console.log("User role from DB:", userRole);
  console.log("Comparison result:", inputRole === userRole);
